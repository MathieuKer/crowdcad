...
import { getFirestore, connectFirestoreEmulator, doc, writeBatch, collection, Firestore } from 'firebase/firestore';
...
async function bulkCreate(db: Firestore, collectionName: string, dataArray: Array<Record<string, any>>) {
...
export async function seedDatabase(projectId: string) {
